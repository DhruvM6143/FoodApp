    ...
    return (
        <div className='font-bold w-[250px] bg-white p-5 flex flex-col gap-2 rounded-lg'>
            ...
            <div className='flex justify-between '>
                ...
                <button onClick={() => { dispatch(addToCart({ id, name, img, rating, price, qty: 1 })), toast.success(`${name} add to your cart`) }} className='p-1 text-white bg-green-500 hover:bg-green-600 rounded-lg text-sm'>Add to cart</button>
            </div>
        </div>
    )
}
